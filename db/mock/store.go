...
// Source: github.com/amer-web/simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.ArrgTransfer) (db.ResultTransfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(db.ResultTransfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
